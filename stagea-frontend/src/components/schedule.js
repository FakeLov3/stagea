...
export default function Schedule() {
    ...
    const hours = ['05:30pm', '05:45pm', '05:45pm', '06:00pm', '06:30pm', '07:00pm'];
    const topics = ['Improve your UI skills', 'Improve your UI skills - Q&A', 
        'Implementing Firebase + Ionic', 'UX is the new black', 'Making great presentations', 'Improve your InDesign skills'];
    const speakers = ['Gabriela Lima', 'Gabriela Lima', 'Diego Buzanello', 'Mauro Cortella', 'Fernanda Gaudard', 'Henrique Miranda'];
    const schedules = [];
